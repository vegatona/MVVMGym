    ...
    public partial class RoutineTuesdayPage : ContentPage
    {
        ...
        private void OnMuscleSelected(object sender, EventArgs e)
        {
            if (MusclePicker.SelectedItem != null)
            {
                ...
                Console.WriteLine($"Músculo seleccionado: {selectedMuscle}");
        ...
        private void ShowExercises(string selectedMuscle)
        {
            ...
            switch (selectedMuscle)
            {
                ...
                case "Triceps":
                    ...
                    exercises.Add(new ExerciseModel { Name = "Press francés con barra EZ (4x10-12 reps)", Image = "press_frances.png" });
                    exercises.Add(new ExerciseModel { Name = "Jalones de tríceps en polea (agarre recto) (3x10-12 reps)", Image = "extencion_triceps.png" });
                    exercises.Add(new ExerciseModel { Name = "Extensión de tríceps por encima de la cabeza con mancuerna (3x10-12 reps)", Image = "extension_triceps_encima_cabeza_con_mancuerna.png" });
                    break;

                case "Espalda":
                    exercises.Add(new ExerciseModel { Name = "Jalón al pecho en polea alta (agarre estrecho) (3x12 reps)", Image = "jalon_pecho_polea_alta_agarre_estrecho.png" });
                    exercises.Add(new ExerciseModel { Name = "Pullover (3x15 reps)", Image = "pull_over.png" });
                    exercises.Add(new ExerciseModel { Name = "Remo con barra T (agarre cerrado) (4x10 reps)", Image = "remo_barra_t_agarre_cerrado.png" });
                    exercises.Add(new ExerciseModel { Name = "Remo en máquina (agarre neutro) (3x10-12 reps)", Image = "remo_maquina_agarre_neutro.png" });
                    break;
                ...
                case "Pierna":
                    ...
                    exercises.Add(new ExerciseModel { Name = "Sentadilla búlgara con mancuernas (3x10-12 reps por pierna)", Image = "sentadillas_bulgaras.png" });
                    break;
            }
