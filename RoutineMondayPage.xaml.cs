...
namespace Mockup
{
    ...
    public partial class RoutineMondayPage : ContentPage
    {
        ...
        {
            if (e.SelectedItem == null) return; // Evita selección nula

            Exercise selectedExercise = e.SelectedItem as Exercise;
            if (selectedExercise != null)
            {
                DisplayAlert("Ejercicio seleccionado", selectedExercise.Name, "OK");
            }

            // Desseleccionar el elemento después de la selección
        ...
        private void ShowExercises(string selectedMuscle)
        {
            ...
            {
                ExercisesListView.ItemsSource = null; // Limpiar lista antes de asignar nuevos valores
            }
            ...
            // Asegurar que la vista es visible
